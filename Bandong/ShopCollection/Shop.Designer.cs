namespace Bandong.Shop
{
	partial class Shop
	{
		...
		private void InitializeComponent()
		{
			...
			this.shopIndexVMBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.addButton = new System.Windows.Forms.Button();
			((System.ComponentModel.ISupportInitialize)(this.dataGridView1)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.shopIndexVMBindingSource)).BeginInit();
			this.SuspendLayout();
			// 
			// dataGridView1
			// 
			...
			this.dataGridView1.DataSource = this.shopIndexVMBindingSource;
			...
			// 
			// shopIndexVMBindingSource
			// 
			this.shopIndexVMBindingSource.DataSource = typeof(Bandong.Models.ViewModels.ShopIndexVM);
			// 
			// addButton
			// 
			this.addButton.Location = new System.Drawing.Point(338, 75);
			...
			((System.ComponentModel.ISupportInitialize)(this.shopIndexVMBindingSource)).EndInit();
		...
		private System.Windows.Forms.BindingSource shopIndexVMBindingSource;
	}
}